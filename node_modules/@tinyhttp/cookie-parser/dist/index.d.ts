 ...
 */
export declare function signedCookie(str: string | unknown, secret: string | string[]): string | false;
/**
 * Parse signed cookies, returning an object containing the decoded key/value
 * pairs, while removing the signed key from obj.
 */
export declare function signedCookies(obj: any, secret: string | string[]): any;
/**
